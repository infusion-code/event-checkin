...
@Component({
    ...
    template: `
        <div class="hidden-xs hidden-sm col-sm-4 col-md-3 col-lg-2 col-xl-1 profile-img-container"> 
    ...
    `,
    styles: [`
        :host { display: inline-block; background-color: #444; width: 100%; min-height: 100px; }
        :host(.red) { background-color: #aa7777; }
        :host(.green) { background-color: #77aa77; }
        ...
        .profile-img {max-width: 75px; position: relative; min-height: 100px; max-width: 150px; max-height: 100px; }
        .profile-img-container { padding: 0px; margin: 0px; overflow: hidden; }
